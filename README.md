...
```bash
git clone https://github.com/harivil/expo-mobile-app.git my-new-app
```
...
| `ios.bundleIdentifier`, `android.package` — from `com.example.` | [`app.json`](app.json)                           |
...
| Review owners — from `@harivil`                                 | [`.github/CODEOWNERS`](.github/CODEOWNERS)       |
